...
class Tank():
	...
	def __init__(self, level, side, position = None, direction = None, filename = None):
		...
		#self.controls = [pygame.K_e, pygame.K_k, pygame.K_l, pygame.K_j, pygame.K_h]
		self.controls = [pygame.K_g, pygame.K_k, pygame.K_l, pygame.K_j, pygame.K_h]
		#self.controls = [pygame.K_SPACE, pygame.K_k, pygame.K_l, pygame.K_j, pygame.K_h]
...
class Game():
		...
		if len(players) == 0:
			...
			if self.nr_of_players == 2:
				...
				#player.controls = [102, 119, 100, 115, 97]
		                #player.controls = [13, pygame.K_UP, pygame.K_RIGHT, pygame.K_DOWN, pygame.K_LEFT]
		                player.controls = [pygame.K_i, pygame.K_z, pygame.K_a, pygame.K_w, pygame.K_s]
				#player.controls = [102, 119, 100, 115, 97]
				players.append(player)
				...
				player = Player(
				  ...
				  self.level, 0, [x, y], self.DIR_UP, (16*4, 16*2, 13*2, 13*2)
				)
				#player.controls = [102, 119, 100, 115, 97]
		                player.controls = [pygame.K_d, pygame.K_u, pygame.K_e, pygame.K_y, pygame.K_o]
		                #player.controls = [13, pygame.K_UP, pygame.K_RIGHT, pygame.K_DOWN, pygame.K_LEFT]
		                #player.controls = [13, pygame.K_w, pygame.K_a, pygame.K_s, pygame.K_d]
				#player.controls = [102, 119, 100, 115, 97]
				players.append(player)
	...
	def drawIntroScreen(self, put_on_surface = True):
		...
		self.writeInBricks("learn", [65, 80])
		self.writeInBricks("vim", [129, 160])
